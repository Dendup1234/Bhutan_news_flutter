...
class _LifeStyleTabState extends State<LifeStyleTab> {
  ...
  Future<void> scrapeNews() async {
    ...
    final response = await http.get(Uri.parse("https://kuenselonline.com/category/life-style/"));
   /*  final response2 = await http.get(Uri.parse("https://thebhutanese.bt/category/business/")); */
