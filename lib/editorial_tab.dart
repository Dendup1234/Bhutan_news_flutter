...
class _EditorialTabState extends State<EditorialTab> {
  ...
  try {
    ...
    print("Failed to parse Kuensel date: $date. Error: $e");
  ...
  Future<void> scrapeNews() async {
    ...
    final response = await http.get(Uri.parse("https://kuenselonline.com/category/editorial/"));
    final response2 = await http.get(Uri.parse("https://thebhutanese.bt/category/editorial/"));
