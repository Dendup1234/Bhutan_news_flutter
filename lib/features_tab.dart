...
class _FeaturesTabState extends State<FeaturesTab> {
  ...
  Future<void> scrapeNews() async {
    ...
    final response = await http.get(Uri.parse("https://kuenselonline.com/category/featured/"));
    final response2 = await http.get(Uri.parse("https://thebhutanese.bt/category/about-town/"));
