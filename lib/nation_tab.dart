...
class _NationTabState extends State<NationTab> {
  ...
  Future<void> scrapeNews() async {
    ...
    final response2 = await http.get(Uri.parse("https://thebhutanese.bt/category/the-nation/"));
    final response3 = await http.get(Uri.parse("https://thebhutanese.bt/category/democracy-in-action/"));
