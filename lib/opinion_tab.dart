...
class OpinionTab extends StatefulWidget {
  const OpinionTab({super.key});

  @override
  State<OpinionTab> createState() => _OpinionTabState();
}

class _OpinionTabState extends State<OpinionTab> {
  ...
  Future<void> scrapeNews() async {
    ...
    final response = await http.get(Uri.parse("https://kuenselonline.com/category/opinions/"));
    final response2 = await http.get(Uri.parse("https://thebhutanese.bt/category/opinion/"));
